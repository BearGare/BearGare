...
Sales rep by day, learning to code by night. Deep in Python and Go via [Boot.dev](https://www.boot.dev) — trying to understand what my customers actually build, not just how to sell it.
...
By day I help enterprise engineering teams ship software faster at [Harness.io](https://www.harness.io). By night I tinker with:
